...
First install the plugin:
    ...
    npm install nodebb-plugin-floating-login
...
nbb.script.src = nbb.url + '/plugins/nodebb-plugin-floating-login/lib/ghost.js';
...
nbb.src = nodeBBURL + '/plugins/nodebb-plugin-floating-login/lib/wordpress.js';
...
```html
	...
	(function() {
	var nbb = document.createElement('script'); nbb.type = 'text/javascript'; nbb.async = true;
	nbb.src = nodeBBURL + '/plugins/nodebb-plugin-floating-login/lib/generalphp.js';
	(document.getElementsByTagName('head')[0] || document.getElementsByTagName('body')[0]).appendChild(nbb);
	})();
	</script>
	<noscript>Please enable JavaScript to view comments</noscript>
